...
var participants_to_exclude = ["4779", "8359", "8481", "10376", "18992", "4598", "5904", "8175", "9249", "7111", "15342",
  "4768", "9336", "16279", "9629", "10376", "10962", "15984", "8359", "11033", "9386", "6742", "5860", "8638", "7511",
  "7441", "10870", "8481",
]
...
var abExcludeNames = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "s", "blue", "green", "magenta", "orange", "pink", "purple", "red", "yellow" ]
...
var enNameReplacingRules = [[/scarlett/, "scarlet"], [/robinseggblue/, "robineggblue"], [/puple/, "purple"], [/perrywinkle/, "periwinkle"], [/perriwinkle/, "periwinkle"], [/muave/, "mauve"], [/marron/, "maroon"], [/linegreen/, "limegreen"], [/lavendar/, "lavender"], [/lavander/, "lavender"], [/forrest/, "forest"], [/chartruse/, "chartreuse"], [/chartruese/, "chartreuse"], [/burgendy/, "burgundy"], [/burgandy/, "burgundy"], [/biege/, "beige"], [/avacado/, "avocado"],[/turquise/, "turquoise"], [/turqouise/, "turquoise"], [/turquise/, "turquoise"], [/turquiose/, "turquoise"], [/torquoise/, "turquoise"], [/pruple/, "purple"], [/marroon/, "maroon"], [/majenta/, "magenta"], [/yello$/, "yellow"], [/fusha/, "fuchsia"], [/fuchia/, "fuchsia"], [/fucsia/, "fuchsia"], [/fusia/, "fuchsia"], [/fushia/, "fuchsia"], [/fuschia/, "fuchsia"], [/fuscia/, "fuchsia"], [/fuscia/, "fuchsia"], [/lavender/, "lavender"], [/lavender/, "lavender"], [/turqoise/, "turquoise"], [/grey/, "gray"]];
...
function refine(cn){
    ...
    if (cn.lang0.indexOf("Korean") >= 0) {
      ...
      if(poExcludedNames.indexOf(cn.name) >= 0){
        cn.name = ""
      }
      ...
      if (abExcludeNames.indexOf(cn.name) >= 0 ) {
        cn.name = "";
      }
