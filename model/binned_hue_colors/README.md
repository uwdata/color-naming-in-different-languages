...
Hue Color Bins (with extra added to each side so you can see the overlap):

![The hue colors binned](../../vis/hue-color-bins.png)

*Note: RGB Hue colors are defined as colors with max(r,g,b) == 255 and min(r,g,b) == 0.*
